        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link  <?php echo isset($_GET['page']) && $_GET['page'] == 'stock' ? 'active' : ''?>" href="?page=stock"> <!-- focus that!! -->
                            <span class="nav-icon">
                            </span>
                    ...
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link  <?php echo isset($_GET['page']) && $_GET['page'] == 'bank' ? 'active' : ''?>" href="?page=bank">
                    ...
                    <!-- <li class="nav-item">
                        ...
                        <a class="nav-link <?php //echo isset($_GET['page']) && $_GET['page'] == 'test_page' ? 'active' : ''?>" href="?page=test_page">
                            ...
                            <span class="nav-link-text">TEST PAGE</span>
                        </a>
                        //nav-link
                    </li> -->
            ...
            <div class="app-sidepanel-footer">
                <nav class="app-nav app-nav-footer">
                    <ul class="app-menu footer-menu list-unstyled">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page'] == 'orders_status' ? 'active' : ''?>" href="/onlybook_shop/login/index.php">  <!-- focus that-->
