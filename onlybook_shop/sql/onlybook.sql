...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2336476867ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=lots">`packing`.`lots`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=sells">`packing`.`sells`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=labels">`packing`.`labels`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=split_label_details">`packing`.`split_label_details`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=split_labels">`packing`.`split_labels`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=tags">`packing`.`tags`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=sell_labels">`packing`.`sell_labels`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=sell_cpo_items">`packing`.`sell_cpo_items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=products">`packing`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=packing&table=printers">`packing`.`printers`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="48612c6f6070376d6e4b5b57652c467c">
